...
export default function Model({ scrollProgress, cameraScrollCurve, ...props }) {
  ...
  const regular = useKTX2Texture("/textures/regular.png");
  const samurai = useKTX2Texture("/textures/samurai.png");
  const pirate = useKTX2Texture("/textures/pirate.png");
  const desert = useKTX2Texture("/textures/desert.png");
  const zombie = useKTX2Texture("/textures/zombie.png");
